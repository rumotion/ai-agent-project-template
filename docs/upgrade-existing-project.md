...
3. **Context Budget Compliance**: Ensure `AGENTS.md` remains <= 4,700 chars and `memory-bank/handoff.md` remains <= 1,200 chars.
...
5. **Install Validator & Benchmarks**: Copy `scripts/check-template.py` (v0.8.0), `scripts/benchmark-context.py`, and `benchmarks/context/`.
6. **Validate & Commit**:
